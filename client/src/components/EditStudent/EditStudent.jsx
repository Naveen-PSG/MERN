...
class EditStudent extends Component {
  ...
  async componentDidMount() {
    ...
    const { name, email, enrollnumber, phonenumber } = updateStudent.data.student;
    this.setState({ id, name, email, enrollnumber, phonenumber });
    } catch (err) {
    ...
    return (
      <div className="Edit-Student-Wrapper">
        ...
        <form onSubmit={this.updateStudentHandler}>
          ...
          <input
            type="number"
            placeholder="Enter the student's phonenumber"
